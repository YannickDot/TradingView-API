 ...
 */
export type Screener = string | 'forex' | 'crypto' | 'america' | 'australia' | 'canada' | 'egypt' | 'germany' | 'india' | 'israel' | 'italy' | 'luxembourg' | 'poland' | 'sweden' | 'turkey' | 'uk' | 'vietnam';
 ...
 * @returns {Screener}
*/
declare function getScreener(exchange: string): string;
/**
 * Get a screener from an exchange
 * @function getScreener
 * @param {string} exchange Example: BINANCE, EURONEXT, NASDAQ
 ...
 */
declare function getTA(screener: string, id: string): Promise<Periods>;
/**
 * Get technical analysis
 * @function getTA
 * @param {Screener} screener Market screener
 ...
 */
declare function searchMarket(search: string, filter?: "index" | "crypto" | "forex" | "stock" | "futures" | "cfd" | "economic"): Promise<{
    /**
     * Market full symbol
     */
    id: string;
 ...
 * @returns {Promise<User>} Token
 */
declare function getUser(session: string, location?: string): Promise<{
    /**
     * User ID
     */
    id: number;
 ...
 * @returns {Promise<SearchIndicatorResult[]>} Search results
 */
declare function getPrivateIndicators(session: string): Promise<{
    /**
     * Script ID
     */
    id: string;
