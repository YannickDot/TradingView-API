declare function _exports(client: import('../client').ClientBridge): {
    new (): {
        ...
        /** Parent client */
        "__#7@#client": import("../client").ClientBridge;
        /** @type {StudyListeners} */
        "__#7@#studyListeners": StudyListeners;
        /**
         ...
         */
        "__#7@#handleEvent"(ev: ChartEvent, ...data: {}[]): void;
        ...
        "__#7@#chartSession": ChartSessionBridge;
        Study: {
            new (indicator: import("../classes/PineIndicator") | import("../classes/BuiltInIndicator")): {
                ...
                "__#6@#strategyReport": studyConstructor.StrategyReport;
